...
# What are different GAN architectures used go language modeling?
...
# If encoder is for understanding and decoder for generation then how come GPT (decoder only architecture), undrstands context?
