...
|16. |Text Generation |Pytorch |AlexaTM 20B is a multitask, multilingual, large-scale sequence-to-sequence (seq2seq) model, trained on a mixture of Common Crawl (mC4) and Wikipedia data across 12 languages, using denoising and Causal Language Modeling (CLM) tasks  License: [Alexa Teacher Model] https://jumpstart-cache-prod-us-east-2   |Model ID: pytorch-textgeneration1-alexa20b
