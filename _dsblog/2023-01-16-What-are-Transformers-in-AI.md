...
| 13. | [GPT](https://huggingface.co/docs/transformers/model_doc/openai-gpt) [Paper](https://blog.openai.com/language-unsupervised/) | Improving Language Understanding by Generative Pre-Training | Autoregressive | Jun-2018 | OpenAI
...
| 187. | [BLOOM](https://huggingface.co/docs/transformers/model_doc/bloom) [Paper](https://arxiv.org/abs/2010.10499) |  | Vision Transformer | Nov-2021 | BigScience workshop
